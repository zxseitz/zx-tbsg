...
class ReversiTest {
    ...
    private val actions: MutableMap<Action, Collection<Int>> = mock(MutableMap::class.java) as MutableMap<Action, Collection<Int>>
    ...
    fun testUpdateInvalidIndex() {
        try {
            ...
            Assert.assertEquals("Index defined in action is invalid", ge.message)
        }
    }
    ...
    fun testUpdatePlaceBlackNextWhite() {
        ...
        try {
            ...
            Assert.assertEquals(GameState.RUNNING, match.state)
            Assert.assertEquals(2, match.next)
        } catch (e: Exception) {
            e.printStackTrace()
            Assert.fail()
        }
    ...
    fun testInvokePlaceBlackNextBlack() {
        ...
        try {
            ...
            Assert.assertEquals(GameState.RUNNING, match.state)
            Assert.assertEquals(1, match.next)
        } catch (e: Exception) {
            e.printStackTrace()
            Assert.fail()
        }
    ...
    fun testInvokePlaceBlackWon() {
        ...
        try {
            ...
            Assert.assertEquals(GameState.FINISHED, match.state)
            Assert.assertEquals(1, match.next)
        } catch (e: Exception) {
            e.printStackTrace()
            Assert.fail()
    ...
    fun testInvokePlaceTie() {
        ...
        try {
            ...
            Assert.assertEquals(GameState.FINISHED, match.state)
            Assert.assertEquals(0, match.next)
        } catch (e: Exception) {
            e.printStackTrace()
            Assert.fail()
        }
